...
export default function Home() {
  return (
    <Layout className="">
      <section className="main-grid p-8 pb-24">
        <h2 className="text-4xl pt-4 pb-2 font-semibold">
          Privacy Policy for BookShop
        </h2>
        <p>
          At BookShop, accessible from
          https://web-production-7efa.up.railway.app/, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by BookShop and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in BookShop. This policy
        ...
        <h3 className="text-3xl pt-10 pb-2">Consent</h3>
        <p>
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <h3 className="text-3xl pt-4 pb-2">Information we collect</h3>
        <p>
        ...
        <h3 className="text-3xl pt-4 pb-2">How we use your information</h3>
        <p>
        ...
        <h3 className="text-3xl pt-4 pb-2">Log Files</h3>
        <p>
          BookShop follows a standard procedure of using log files. These files
        ...
        <h3 className="text-3xl pt-4 pb-2">Cookies and Web Beacons</h3>
        <p>
          Like any other website, BookShop uses 'cookies'. These cookies are
        ...
        <h3 className="text-3xl pt-4 pb-2">
          Advertising Partners Privacy Policies
        </h3>
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of BookShop. Third-party ad servers or ad
          ...
          on BookShop, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that BookShop has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <h3 className="text-3xl pt-4 pb-2">Third Party Privacy Policies</h3>
        <p>
          BookShop's Privacy Policy does not apply to other advertisers or
        ...
        <h3 className="text-3xl pt-4 pb-2">GDPR Data Protection Rights</h3>
        <p>
        ...
        <h3 className="text-3xl pt-4 pb-2">Children's Information</h3>
        <p>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          BookShop does not knowingly collect any Personal Identifiable
