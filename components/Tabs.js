                        ...
                        <li className="mr-4 flex-1 text-center">
                            <a
                                className={
                                    ...
                                    (openTab === 1
                                        ? "cursor-default text-slate-700 bg-slate-100 dark:text-slate-100 dark:bg-slate-900"
                                        : "text-slate-900 bg-slate-300 transition-all dark:text-slate-100 dark:bg-slate-800"
                                    )
                                }
                                onClick={e => {
                                    e.preventDefault();
